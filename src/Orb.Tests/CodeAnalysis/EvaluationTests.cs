...
namespace Orb.Tests.CodeAnalysis
{
    public class EvaluationTests
    {
        ...
        [InlineData("1.5+2.0", 3.5)]
        [InlineData("1.5-2.0", -0.5)]
        ...
        [InlineData("4 >= 4", true)]
        [InlineData("5 >= 4", true)]
        [InlineData("4.1 < 4.2", true)]
        [InlineData("4.2 < 4.1", false)]
        [InlineData("4.1 <= 4.2", true)]
        [InlineData("4.2 <= 4.1", false)]
        [InlineData("4.1 > 4.2", false)]
        ...
        [InlineData("4.3 == 4.2", false)]
        [InlineData("4.3 != 4.2", true)]
        ...
        public void Evaluator_Void_Function_Should_Not_Return_Value()
        {
            ...
            var diagnostics = @"
                Since 'test' returns void, a return keyword must not be followed by an expression.
            ";
        ...
        public void Evaluator_Function_With_ReturnValue_Should_Not_Return_Void()
        {
            ...
            var diagnostics = @"
                Expression of type 'int' expected.
            ";
