...
namespace Orb.CodeAnalysis.Syntax
{
    internal sealed class Parser
    {
        ...
        private MemberSyntax ParseFunctionDeclaration()
        {
            ...
            return new FunctionDeclarationSyntax(_syntaxTree, functionKeyword, identifier, openParenthesisToken, parameters, closedParenthesisToken, type, body);
        }
        ...
        private TypeClauseSyntax ParseTypeClause()
        {
            ...
            var identifier = MatchToken(SyntaxKind.IdentifierToken);
            return new TypeClauseSyntax(_syntaxTree, colon, identifier);
        }
        ...
        private StatementSyntax ParseForStatement()
        {
            ...
            var identifier = MatchToken(SyntaxKind.IdentifierToken);
            var eqToken = MatchToken(SyntaxKind.EqualsToken);
            var lowerBound = ParseExpression();
            var toKeyword = MatchToken(SyntaxKind.ToKeyword);
            var upperBound = ParseExpression();
            var body = ParseStatement();
            return new ForStatementSyntax(_syntaxTree, keyword, identifier, eqToken, lowerBound, toKeyword, upperBound, body);
        }
